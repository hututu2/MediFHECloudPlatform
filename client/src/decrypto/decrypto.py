...
class decrypto:
    def __init__(self, root, id, isTKroot=True):
        ...
        Button_10.configure(
            command=lambda: decrypto_cmd.Button_10_onCommand(uiName, "Button_10")
        )
        Button_10_Ft = tkinter.font.Font(
            family="System",
            size=12,
            weight="bold",
            slant="roman",
        ...
        Button_14.configure(
            command=lambda: decrypto_cmd.Button_14_onCommand(
                uiName, "Button_14", self.id
            )
        )
        Button_14_Ft = tkinter.font.Font(
            family="System",
            size=12,
            weight="bold",
            slant="roman",
        ...
        Button_15.configure(
            command=lambda: decrypto_cmd.Button_15_onCommand(uiName, "Button_15")
        )
        Button_15_Ft = tkinter.font.Font(
            family="System",
            size=8,
            weight="bold",
            slant="roman",
