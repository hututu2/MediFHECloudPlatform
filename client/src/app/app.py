...
class app:
    def __init__(self, root, isTKroot=True):
        ...
        Button_11_Ft = tkinter.font.Font(
            family="宋体",
            size=16,
            weight="normal",
            slant="roman",
        ...
        Button_12_Ft = tkinter.font.Font(
            family="宋体",
            size=16,
            weight="normal",
            slant="roman",
